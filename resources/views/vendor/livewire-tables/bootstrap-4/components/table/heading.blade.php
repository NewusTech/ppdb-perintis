@props(['column', 'sortingEnabled' => true, 'sortable' => null, 'direction' => null, 'text' => null, 'customAttributes' => []])
...
@else
    <th wire:click="sortBy('{{ $column }}', '{{ $text ?? $column }}')" {{ $attributes->merge($customAttributes) }}
