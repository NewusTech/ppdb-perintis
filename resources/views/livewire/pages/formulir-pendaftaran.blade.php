@slot('title', 'Formulir Pendaftaran')
            ...
            <div class="card-body">
                ...
                <div class="tab-content pt-4 text-muted">
                    <div class="tab-pane active" id="executive" role="tabpanel">
                        ...
                        <hr class="mt-n1">
                        @livewire('tables.formulir-pendaftaran-table', ['kelas_id' => 1])
                    </div>
                    <div class="tab-pane" id="reguler-ac" role="tabpanel">
                        ...
                        <hr class="mt-n1">
                        @livewire('tables.formulir-pendaftaran-table', ['kelas_id' => 2])
                    </div>
                    <div class="tab-pane" id="reguler-non-ac" role="tabpanel">
                        ...
                        <hr class="mt-n1">
                        @livewire('tables.formulir-pendaftaran-table', ['kelas_id' => 3])
                    </div>
                </div>
            </div>
        </div>
