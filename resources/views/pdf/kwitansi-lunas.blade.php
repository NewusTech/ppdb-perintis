...
<head>
    ...
    <title>Kwitansi Lunas - {{ $pendaftar->user->name }}</title>
    <style>
        @page {
            margin: 1rem;
        }
        ...
        <div style="padding: 0 10px 0 10px; vertical-align: middle;">
            <table class="mt-n2 w-100">
                <tr>
                    ...
                    <td rowspan="2" class="rounded text-uppercase text-center text-white" style="background-color:black; vertical-align: middle; font-size: 15pt; font-style: italic; font-weight: bold;">
            ...
            <table class="w-100">
                ...
                <tr>
                    <td>Uang SPP 2 Bulan (Juli & Agustus {{ date('Y') }}) @ Rp.
                        {{ number_format($params['uang_spp'], 0, ',', '.') }} / Bln
                    </td>
            ...
            <table class="w-100" style="margin-top: 1.7rem">
                <tr>
                    <td style="width: 40%"></td>
                    <td style="width: 20%; font-size: 15pt;" class="font-weight-bold text-center rounded bg-secondary p-2">L U N A S
                    </td>
                    <td style="width: 40%"></td>
                </tr>
            </table>
